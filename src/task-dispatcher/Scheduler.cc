...
static_assert(sizeof(Task) == Task::TTask_NumBytesTotal, "task type is unexpectedly large");
static_assert(sizeof(Task[8]) == Task::TTask_NumBytesTotal * 8, "task arrays are unexpectedly large, overaligned?");
